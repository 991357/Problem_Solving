    ...
    public static void main(String[] args) throws IOException
    {
        ...
        for(int t = 0; t < T; t++)
        {
            ...
            for(int i = 0; i < 9; i++)
            {
                ...
                while (line != null && line.trim().isEmpty()) { // 빈 줄이면 건너뛰기
                    line = br.readLine();
                }
                st = new StringTokenizer(line); // ★ 여기서 반드시 초기화
                for (int j = 0; j < 9; j++) {
            ...
            {
                sb.append("Case ").append(t + 1).append(": INCORRECT");
                if(t != T - 1)
                    sb.append("\n");
                continue;
            }
            ...
            sb.append("Case ").append(t + 1).append(": CORRECT");
            if(t != T - 1)
                sb.append("\n");
        }
